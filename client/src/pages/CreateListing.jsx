    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          {uploading && (<p className="text-red-700">please wait until the image is uploading</p>)}
          ...
          <button disabled={loading || uploading} className="p-3  border border-slate-700 rounded uppercase bg-slate-700 text-white hover:bg-white hover:text-slate-700 disable:opacity-80">
